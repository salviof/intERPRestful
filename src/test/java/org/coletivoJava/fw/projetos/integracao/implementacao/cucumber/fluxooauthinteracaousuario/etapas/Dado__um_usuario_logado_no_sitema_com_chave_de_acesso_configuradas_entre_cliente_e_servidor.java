...
public class Dado__um_usuario_logado_no_sitema_com_chave_de_acesso_configuradas_entre_cliente_e_servidor {
    ...
    @Dado(EtapasFluxoOauthInteracaoUsuario.DADO_UM_USUARIO_LOGADO_NO_SITEMA_COM_CHAVE_DE_ACESSO_CONFIGURADAS_ENTRE_CLIENTE_E_SERVIDOR)
    public void implementacaoEtapa() {
        FluxoOauth2UsuarioAcessoRestfull.renovarConexaoEntityManagerEscopoTeste();
        ...
        SBCore.getServicoSessao().logarEmailESenha(FluxoOauth2UsuarioAcessoRestfull.EMAIL_USUARIO_AUTENTICADO, "123456");
